...
public class NeoConsole_SteamAddon : Mod
{
    ...
    public override void PatchMod()
    {
        ...
        ModLoader.InsertGMLString(ModFiles.GetCode("commandsMap.gml"), "scr_neoconsole_init", 13);
        ModLoader.InsertGMLString(ModFiles.GetCode("helpSyntaxMap.gml"), "scr_neoconsole_init", 77);
        ModLoader.InsertGMLString(ModFiles.GetCode("helpUsageMap.gml"), "scr_neoconsole_init", 138);
    }
}
